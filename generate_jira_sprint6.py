...
OUT_PATH = DATASET_DIR / "generated" / "jira" / "sprint6_jira.xlsx"
BLUEPRINT_PATH = DATASET_DIR / "sprint_6.md"
EXPECTED_TICKETS = 13
...
def _call_ticket_json(
    ...
    *,
    ...
    user = (
        ...
        '      "comment_number": 1,\n'
        '      "author": "full name",\n'
        '      "date": "use realistic dates consistent with the Sprint 6 blueprint (Mar 12–Mar 31, 2025)",\n'
...
def _write_workbook(rows_tickets: list[list[Any]], rows_comments: list[list[Any]]) -> Path:
    ...
    try:
        ...
        fallback = OUT_PATH.with_name("sprint6_jira_ready.xlsx")
...
def main() -> int:
    ...
    if saved != OUT_PATH:
        print(
            ...
            "Close sprint6_jira.xlsx and rename/copy the new file, or rerun this script."
        )
    else:
        print(f"\nWrote {saved}")
    return 0
