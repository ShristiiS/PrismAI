...
OUT_PATH = DATASET_DIR / "generated" / "jira" / "sprint10_jira.xlsx"
# User asked for sprint10_ticket_definitions.md, but the repo currently contains Sprint 10 tickets in Sprint_10.md.
BLUEPRINT_PATH = DATASET_DIR / "Sprint_10.md"
EXPECTED_TICKETS = 9
...
def _split_ticket_blocks(markdown: str) -> list[str]:
    # Sprint 10 blueprint format uses "## TICKET N" sections.
...
def _call_ticket_json(
    ...
    *,
    ...
    user = (
        ...
        '      "comment_number": 1,\n'
        '      "author": "full name",\n'
        '      "date": "use realistic dates consistent with the Sprint 10 blueprint (mid–late May 2025)",\n'
...
def _write_workbook(rows_tickets: list[list[Any]], rows_comments: list[list[Any]]) -> Path:
    ...
    try:
        ...
        fallback = OUT_PATH.with_name("sprint10_jira_ready.xlsx")
...
def main() -> int:
    ...
    if saved != OUT_PATH:
        print(
            ...
            "Close sprint10_jira.xlsx and rename/copy the new file, or rerun this script."
        )
    else:
        print(f"\nWrote {saved}")
    return 0
